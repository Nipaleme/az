...
,
		"classnamespace" : "box",
		"rect" : [ 286.0, 122.0, 1208.0, 1005.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 679.0, 132.0, 100.0, 21.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 838.0, 132.0, 100.0, 21.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 167.0, 11.776671999999962, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 163.766764666666859, 7.776671999999962, 36.0, 19.0 ],
					"text" : "Index"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.466764666667132, 151.0, 50.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 107.466764666667132, 7.776671999999962, 50.0, 21.0 ],
					"text" : "#2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 903.0, 168.0, 71.0, 21.0 ],
					"text" : "loadmess 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 722.0, 178.0, 71.0, 21.0 ],
					"text" : "loadmess 30"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1377.766764666666404, 85.0, 50.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 280.5, 7.776671999999962, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 1378.0, 110.0, 29.5, 21.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1445.0, 64.0, 100.0, 21.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1378.0, 49.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1307.0, 174.0, 100.0, 21.0 ],
					"text" : "pack s i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.0, 178.0, 65.0, 21.0 ],
					"text" : "loadmess 7"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 334.666568666666535, 7.776671999999962, 36.0, 19.0 ],
					"text" : "Size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 680.616764666666768, 158.0, 33.0, 21.0 ],
					"text" : "t #8"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 54.466764666667132, 103.0, 1271.299999999999272, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1306.766764666666404, 382.0, 126.0, 21.0 ],
					"text" : "s from.swarm.control"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "swarm 1 center [avoid [thresh 96 ][gain 43.00]]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1306.766764666666404, 210.946656000000075, 304.0, 95.0 ],
					"text" : "addswarms ((name $1) (size $2) (coord uniform 0 0 100 100) (speed uniform 0 0 10 10) (color 0.9 0 0 1) (maxspeed 100) (applyrule center (avoid (thresh 50 ) (gain 2.)) (align (gain 0.022)) (wind (gain 0.0) (speed 1 1)) (leftbarrier (position -300) (repulsion 5)) (rightbarrier (position 300) (repulsion 5)) (topbarrier (position 300) (repulsion 50)) (bottombarrier (position -300) (repulsion 5))))"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1160.166764666666495, 318.0, 1316.266764666666404, 318.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 1316.266764666666404, 291.0, 1316.266764666666404, 291.0 ],
					"source" : [ "obj-3", 0 ]
				}
