...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 60.0, 168.5, 65.0, 21.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 85.0, 206.5, 61.0, 31.0 ],
									"text" : "0: Stereo\n1: Binaural"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 85.0, 462.5, 75.0, 19.0 ],
									"text" : "Active Output"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 786.0, 200.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 686.0, 200.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 586.0, 200.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 1,
									"patching_rect" : [ 60.0, 370.0, 100.0, 47.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 60.0, 260.0, 29.5, 21.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 60.0, 300.0, 140.0, 21.0 ],
									"text" : "mc.gate~ 2"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "float", "float", "float" ],
													"patching_rect" : [ 86.0, 213.0, 100.0, 22.0 ],
													"text" : "unpack f f f"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 86.0, 179.0, 105.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 126.5, 292.0, 30.0, 30.0 ]
												}
...
,
									"patching_rect" : [ 586.0, 164.0, 219.0, 21.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 586.0, 280.0, 27.0, 21.0 ],
									"text" : "thru"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 786.0, 234.0, 70.0, 21.0 ],
									"text" : "prepend /roll"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 686.0, 234.0, 78.0, 21.0 ],
									"text" : "prepend /pitch"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 586.0, 234.0, 75.0, 21.0 ],
									"text" : "prepend /yaw"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 725.0, 122.0, 193.0, 31.0 ],
									"text" : "avec Sensor2OSC App with game vector rotation parameter"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 586.0, 127.0, 121.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 147.666666666666686, 47.0, 133.0, 15.0 ],
									"saved_attribute_attributes" : 									{
										"activebgcolor" : 										{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 402.0, 249.0, 46.0, 21.0 ],
									"text" : "/hrtf $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 402.0, 220.0, 95.0, 21.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 329.0, 249.0, 53.0, 21.0 ],
									"text" : "/order $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 329.0, 219.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 59.0, 460.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 59.0, 500.0, 141.0, 21.0 ],
									"text" : "mc.gate~"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 60.0, 550.0, 100.0, 21.0 ],
									"text" : "mc.dac~"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "multichannelsignal", "", "float", "list" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 181.0, 370.0, 102.0, 47.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 281.0, 450.0, 380.0, 138.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 181.0, 250.0, 69.0, 21.0 ],
									"text" : "mc.adc~ 1 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "multichannelsignal", "" ],
									"patching_rect" : [ 181.0, 330.0, 102.0, 21.0 ],
									"text" : "az.stereo.binaural~"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 264.0, 150.0, 291.5, 39.5 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 803.0, 470.0, 100.0, 100.200400801603195 ],
									"pic" : "az-Icon.png"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "az.stereo.binaural~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 1 ],
									"midpoints" : [ 338.5, 315.0, 273.5, 315.0 ],
									"source" : [ "obj-13", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-21", 0 ],
									"midpoints" : [ 595.5, 258.0, 595.5, 258.0 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-21", 0 ],
									"midpoints" : [ 695.5, 267.0, 595.5, 267.0 ],
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-21", 0 ],
									"midpoints" : [ 795.5, 267.0, 595.5, 267.0 ],
									"source" : [ "obj-18", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 1 ],
									"midpoints" : [ 69.5, 432.0, 190.5, 432.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 1 ],
									"midpoints" : [ 595.5, 315.0, 273.5, 315.0 ],
									"source" : [ "obj-21", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 1 ],
									"midpoints" : [ 411.5, 315.0, 273.5, 315.0 ],
									"source" : [ "obj-38", 0 ]
								}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-1::obj-19" : [ "mc.live.gain~[1]", "Stereo", 0 ],
			"obj-1::obj-3::obj-2::obj-2" : [ "live.text[4]", "live.text", 0 ],
			"obj-1::obj-3::obj-2::obj-3" : [ "live.text[3]", "live.text", 0 ],
			"obj-1::obj-48" : [ "live.text[43]", "live.text", 0 ],
			"obj-1::obj-5::obj-11" : [ "live.text[6]", "live.text", 0 ],
			"obj-1::obj-5::obj-110" : [ "live.text[7]", "live.text", 0 ],
			"obj-1::obj-5::obj-16" : [ "live.text[8]", "live.text", 0 ],
			"obj-1::obj-5::obj-55" : [ "live.text[5]", "live.text", 0 ],
			"obj-1::obj-5::obj-606" : [ "live.text[2]", "live.text", 0 ],
			"obj-1::obj-5::obj-607" : [ "live.button[1]", "live.button", 0 ],
			"obj-1::obj-6" : [ "mc.live.gain~", "Binaural", 0 ],
...
, 			{
				"name" : "az.stereo.binaural~.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/az/patchers",
				"patcherrelativepath" : "../patchers",
				"type" : "JSON",
				"implicit" : 1
