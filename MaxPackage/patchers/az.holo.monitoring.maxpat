...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.0, 1605.0, 57.0, 22.0 ],
					"style" : "redness",
					"text" : "unpack s",
					"varname" : "/hrtf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 43.5, 1717.0, 103.0, 22.0 ],
...
,
					"patching_rect" : [ 85.5, 1444.0, 58.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 											{
												"box" : 												{
													...
													"text" : "sprintf script newdefault VIRTUAL 158 1800 spat5.binaural~ @mc 1 @sources %d"
												}
...
, 											{
												"box" : 												{
													...
													"text" : "sprintf script newdefault ADC 158. 1410. mc.adc~"
												}
...
, 											{
												"box" : 												{
													...
													"text" : "sprintf script newdefault DELAYS 158. 1531. spat5.delay~ @channels %d @mc 1"
												}
...
, 											{
												"box" : 												{
													...
													"text" : "sprintf script newdefault GAINS 158. 1482. spat5.diagmatrix~ @channels %d @mc 1"
												}
...
,
					"patching_rect" : [ 128.0, 1197.0, 53.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 128.0, 1231.0, 72.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 2034.0, 74.0, 22.0 ],
					"text" : "mc.dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 158.0, 1891.0, 136.0, 129.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 513.0, 1691.0, 29.0, 21.0 ],
					"text" : "thru",
					"varname" : "hrtf"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 513.0, 1655.0, 46.0, 22.0 ],
					"text" : "/hrtf $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 513.0, 1605.0, 95.0, 21.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 793.5, 1703.25, 380.0, 135.5 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 158.0, 1605.0, 312.0, 133.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 158.0, 1800.0, 225.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 158.0, 1410.0, 225.0, 22.0 ],
					"text" : "mc.adc~",
					"varname" : "ADC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 158.0, 1531.0, 225.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.delay~ @channels 10 @mc 1",
					"varname" : "DELAYS"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 158.0, 1482.0, 225.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "spat5.diagmatrix~ @channels 10 @mc 1",
					"varname" : "GAINS"
				}
